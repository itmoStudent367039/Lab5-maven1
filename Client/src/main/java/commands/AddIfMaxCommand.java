...
public class AddIfMaxCommand extends Command {
    ...
    public AddIfMaxCommand(Client<Serializable> receiver) {
    ...
    public void execute(String... args) throws ExecuteException {
        try {
            Response response = receiver.send(CommandType.ADD_IF_MAX, new Serializable[]{receiver.createProduct(args)});
